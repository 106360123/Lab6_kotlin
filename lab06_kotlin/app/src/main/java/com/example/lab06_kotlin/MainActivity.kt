package com.example.lab06_kotlin
...
class MainActivity : AppCompatActivity() {
    ...
    inner class MyAdapter(private val data: Array<Data?>, private val view: Int) : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            var convertView1 = layoutInflater.inflate(view, parent, false)
            val name = convertView1.findViewById<TextView>(R.id.name)
            name.setText(data[position]!!.name)
            val imageView = convertView1.findViewById<ImageView>(R.id.imageView)
